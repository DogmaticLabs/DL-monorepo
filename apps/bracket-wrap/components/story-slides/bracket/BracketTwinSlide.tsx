import { BracketTwinData, Team } from '@/app/api/bracket-data'
...
const BracketTwinSlide = () => {
  ...
  const { data, shareId } = bracketSlidesData!.wrapped.bracket.twinBracket!
  ...
  const handleShare = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // Share options
    const shareOptions = {
      title: `Bracket Twins: ${bracketSlidesData!.info.bracket.data.member.displayName} & ${data.member.displayName}`,
  ...
  return (
    <div className='w-full h-dvh overflow-hidden'>
                      ...
                      >
                        ...
                        <div className='mt-5 mb-2'>
                          <BracketOwnerCard
                            ...
                            teamLogo={teams?.[data.winnerId!]?.images?.primary}
                            delay={0.4}
      ...
      >
        <StoryCard title={<BracketTwinTitle />} animated={false} showGroup showBracket>
          <SimilaritySection twinsData={data} />
  ...
  return (
    ...
    >
      <div className='flex justify-center gap-2'>
        <h2 className='text-4xl font-black text-white tracking-tight leading-none'>My Twin</h2>
...
const SimilaritySection: React.FC<{ twinsData: BracketTwinData }> = ({ twinsData }) => {
  return (
    <motion.div
      className='mb-1'
      initial={{ opacity: 0, y: 20 }}
...
export default BracketTwinSlide
